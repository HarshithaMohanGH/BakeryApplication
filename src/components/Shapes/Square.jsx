...
export default function SquareBiscuit() {
    ...
    return (
        <div className="flex items-center justify-center space-x-4 font-serif">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/002/355/565/small_2x/square-biscuit-in-cartoon-style-isolated-free-vector.jpg" alt="Square" className="h-48 rounded-lg " />
            <div>
